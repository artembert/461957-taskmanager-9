...
const renderPage = () => {
  ...
  const filterTemplate = `<section class="main__filter filter container">
  <input
    type="radio"
    id="filter__all"
  ...
  const boardTemplate = `<section class="board container" id="board">
  ...
  <div class="board__tasks" id="board-tasks">
  </div>
</section>`;
  const loadMoreTemplate = `<button class="load-more" type="button">load more</button>`;
  const taskTemplate = `<article class="card card--black">
  ...
  const editTaskTemplate = `<article class="card card--edit card--yellow card--repeat">
